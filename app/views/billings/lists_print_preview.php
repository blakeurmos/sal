...
<script type="text/javascript">
	function printDiv(divId)
	{
		...
		newWin.document.write('<html>'+<?php echo $css;?>+'<body onload="window.print()">'+divToPrint.innerHTML+'</body></html>');
...
<span class="print_button">
	...
	<?php echo $this->Html->link(
							$this->Html->image('led-ico/printer.png',array('border'=>'none')).'Print',
							'javascript:void();',
							array('escape'=>false,'title'=>'Print','onclick'=>'printDiv(\'id_div_service_log\');')); 
							?>
</span>
